(* README: Alex Snyder: I did all the required problems except normal_forms_unique and
   multistep_eval*)
...
Proof.
  unfold deterministic. intros x y1 y2 Hy1 Hy2.
  generalize dependent y2. induction Hy1; intros y2 Hy2; subst. 
    - inversion Hy2. 
      + reflexivity.
      + inversion H2.
      + inversion H3.
...
Proof.
  ...
  generalize dependent y2.
  induction P11; intros y2 P1 P2.
  - inversion P1; subst.
    + inversion P1; subst. reflexivity.
      reflexivity.
    + inversion P1; subst. reflexivity. inversion H. subst. 
Admitted.
(** [] *)
...
Proof.
  ...
  - inversion H; subst. apply IHt1 in H2. apply IHt2 in H4.
    Print multi_trans. apply multi_trans with (y := (P (C n1) t2)).
     * apply multistep_congr_1 with t1 (C n1) t2 in H2. apply H2.
...
Proof.
  ...
  - intros. inversion H0; subst. constructor.
    apply H3. apply IHHs in H5. apply H5.
Qed.
(** [] *)
...
eapply multi_step. apply CS_Par2. destruct H.
 rewrite H0. simpl. apply CS_IfTrue.
...
eapply multi_step. apply CS_Par2. apply CS_SeqFinish.
unfold par_loop. destruct H. rewrite <- H. rewrite NPeano.Nat.add_1_r.
 eapply multi_refl.
Qed. 
(** [] *)
...
Proof.
  ...
  - destruct IHn. destruct H1. destruct H2.
    eapply ex_intro. split.
      + eapply multi_trans.
        * apply H1.
        * apply par_body_n__Sn. split.
           apply H2. apply H3.
    + split. constructor. unfold t_update. simpl. apply H3.  
Qed.
(** [] *)
